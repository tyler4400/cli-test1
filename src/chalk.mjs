...
console.log(chalk.white('hello imooc') + '!' + chalk.blue('hello imooc!'));
console.log(chalk.red.bgGreen.bold('Hello imooc'));
console.log(chalk.yellow('hello', 'imooc'));
...
const customChalk = new Chalk({ level: 3 }); // level表示支持的颜色等级， 0就什么颜色都没有了
